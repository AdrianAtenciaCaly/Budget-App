 ...
 * Icons.tsx
 *
 * Sistema centralizado de iconos SVG.
 * Elimina la duplicación de SVGs inline por todo el proyecto.
 * Cada icono acepta un `className` opcional para personalización.
 */
...
export function EyeOpen({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size} height={size} viewBox="0 0 24 24"
...
export function EyeClosed({ size = 16, className = '' }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size} height={size} viewBox="0 0 24 24"
