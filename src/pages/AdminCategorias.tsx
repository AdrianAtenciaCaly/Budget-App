...
const TYPES: { value: CategoriaTipo; label: string }[] = [
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-ink/50 mt-1">
          Las categorías con datos no pueden editarse ni eliminarse para proteger la integridad de los presupuestos existentes.
        </p>
      </div>
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] uppercase tracking-wide text-ink/40 px-1.5 py-0.5 border border-moss-200 rounded-full">
                    {TYPES.find((t) => t.value === cat.tipo)?.label}
                  </span>
                  {cat.inUse && (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`text-xs px-3 py-1.5 rounded-lg border transition ${
                      cat.inUse
                        ? 'border-moss-100/50 text-ink/20 cursor-not-allowed'
                        : 'border-clay/30 text-clay/50 hover:text-clay hover:border-clay/50'
                    }`}
                  >
